...
- Пароль: `Miharulez!1` (хранится в `android/key.properties`)
- Срок действия: до 10 июня 2053
- SHA-1: `EF:C2:CA:41:1D:71:1F:FF:2B:98:8A:7A:41:D9:B3:10:D2:13:6A:46`

**⚠️ ВАЖНО:** Сохраните keystore файл и пароль в надежном месте! Без них вы не сможете обновлять приложение в Play Store.
